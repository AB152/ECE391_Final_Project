...
extern int32_t read_file(uint32_t inode, uint32_t offset, uint8_t* buf, int32_t nbytes);
...
extern int32_t read_dir(uint32_t inode, uint32_t offset, uint8_t* buf, int32_t nbytes);
