...
/* 
* IMPORTANT PLEASE READ!! We can just boot up all three terminals in our scheduling algorithm
* b/c of our PIT (refer to most recent supplemental session). Once you read this, you can delete
* this function
*/
